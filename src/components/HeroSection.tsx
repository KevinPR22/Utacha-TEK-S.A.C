      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="max-w-3xl text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <button 
                ...
                className="inline-flex justify-center items-center gap-2 bg-sky-600 hover:bg-sky-500 text-white px-8 py-4 rounded-md font-bold text-lg transition-all duration-200 transform hover:-translate-y-1 shadow-lg shadow-sky-600/25 cursor-pointer"
              >
                Ver Catálogo
                <ArrowRight size={20} />
              </button>
          ...
          <div className="hidden lg:block relative">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-slate-700/50 transform hover:scale-[1.02] transition-transform duration-500">
              <img 
                src="/hero-image.png" 
                alt="Técnico de Utacha TEK trabajando con equipos de radiofrecuencia y análisis de espectro" 
                className="w-full h-auto max-h-[600px] object-cover"
              />
              <div className="absolute inset-0 bg-sky-900/10 mix-blend-multiply"></div>
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-transparent to-transparent"></div>
            </div>
            {/* Elemento de diseño de fondo para que se vea más tecnológico */}
